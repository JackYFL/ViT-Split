...
tune_register = False
work_dir = f"./work_dirs/linear_dinov2-large_vitsplit-learnablegate_cityscapes20k_tuned{tuned_num}layers_frozen{frozen_num}layers"
#########################
...
model = dict(
    type="EncoderDecoder",
    backbone=dict(type="DINOViTSplitLearnableGate",
                  backbone_size="large",
