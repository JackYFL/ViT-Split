...
num_classes = 19 
pergpu_batch_size = 1
frozen_indices = [8, 9, 10, 11]
frozen_num = 8
tuned_indices = [7, 8, 9, 10, 11]
register_version = False
tune_register = False
work_dir = "./work_dirs/linear_dinov2-small_vitsplit_cityscapes20k_tuned5layers_frozenlast4layers"
#########################
...
optimizer = dict(type="AdamW", lr=initial_lr, weight_decay=wd, 
                paramwise_cfg=dict(
                custom_keys={
                    'backbone': dict(lr_mult=lr_mult)  # Apply a learning rate multiplier of 0.1 to the backbone
                }),
