...
frozen_num = 4
tuned_num = 4
frozen_indices = [i for i in range(12-frozen_num, 12)]
tuned_indices = [i for i in range(12-tuned_num, 12)]
register_version = False
tune_register = False
work_dir = "./work_dirs/linear_dinov2-base_vitsplit_pascal_context_20k_tuned4layers_frozenlast4layers"
#########################
