...
tuned_num = 6
total_layers = 24
frozen_indices = [i for i in range(total_layers-frozen_num, total_layers)]
tuned_indices = [i for i in range(total_layers-tuned_num, total_layers)]
register_version = False
tune_register = False
work_dir = "./work_dirs/linear_dinov2-large_vitsplit_pascal_context_20k_tuned6layers_frozenlast10layers"
#########################
