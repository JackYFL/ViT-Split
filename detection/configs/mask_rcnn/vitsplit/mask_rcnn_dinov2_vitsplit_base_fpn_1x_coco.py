...
tune_register = False
# dir_name = f"maskrcnn_fpn1x_dinov2_vitb14_coco_splithead_{frozen_num}frozen_layers_start{start}_{tuned_num}tuning_layers_lr1e-4_lrlayerdecay{layer_decay_rate}_4pyramids_fpnneck_256dim"
#############################################
