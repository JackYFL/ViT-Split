...
tune_register = False
dir_name = f"maskrcnn_fpn1x_dinov2_vitl14_coco_splithead_{frozen_num}frozen_layers_start{start}_{tuned_num}tuning_layers_lr1e-4_lrlayerdecay{layer_decay_rate}_4pyramids_fpnneck_256dim"
resume_from = "/home/liyifa11/MyCodes/ViT-Adapter/detection/work_dirs/maskrcnn_fpn1x_dinov2_vitl14_coco_splithead_8frozen_layers_start6_23tuning_layers_lr1e-4_lrlayerdecay0.62_4pyramids_fpnneck_256dim/epoch_6.pth"
#############################################
...
optimizer = dict(
    ...
    paramwise_cfg=dict(num_layers=total_layers, layer_decay_rate=layer_decay_rate)
    )
