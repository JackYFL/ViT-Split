...
def main():
    ...
    if args.work_dir is not None:
        ...
        cfg.work_dir = osp.join('./work_dirs',
                                osp.splitext(osp.basename(args.config))[0], args.version)
    ...
    # model.init_weights() # change the weights of dinov2 attn
    total_num_elements, trainable_num_elements = get_parameter_number(model) # 打印参数量
